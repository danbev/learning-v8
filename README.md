...
The output of the CodeStubAssembler is IR which is then used by Turbofan to
create the actual machine code instructions. Where in the build does this happen?  
...
blog. We also need to install the function in bootstrapper.cc:
```c++
 SimpleInstallFunction(isolate_, math, "is42", Builtins::kMathIs42, 1, true);
```
